# Food App - Мобильное приложение для заказа еды

Мобильное приложение для заказа еды с каталогом, конструктором блюд, корзиной, оформлением заказа и реферально-бонусной программой.
